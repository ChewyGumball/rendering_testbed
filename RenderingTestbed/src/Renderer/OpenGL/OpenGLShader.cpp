...
void OpenGLShader::setUniform3f(const std::string uniformName, glm::vec3 data)
{
	m_shader->setUniform3f(uniformName, data);
}

void OpenGLShader::setUniform4f(const std::string uniformName, glm::vec4 data)
{
	m_shader->setUniform4f(uniformName, data);
}

void OpenGLShader::setUniformMatrix4f(const std::string  uniformName, glm::mat4 data)
{
