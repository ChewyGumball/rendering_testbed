...
OpenGLRenderModel::OpenGLRenderModel(const OpenGLRenderMesh& mesh, RenderResourceID shaderID, const std::unordered_map<std::string, std::shared_ptr<TextureBuffer>> textures)
...
void OpenGLRenderModel::reload(std::shared_ptr<OpenGLRenderMesh> mesh, RenderResourceID shaderID)
{
}
